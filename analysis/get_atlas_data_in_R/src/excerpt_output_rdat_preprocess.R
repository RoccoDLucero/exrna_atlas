###################################################################################################
##title:                 excerpt_output_rdat_preprocess.R
...
###################################################################################################
##description:   functions for retrieval and processing ExceRpt job output into
##               a few comprehensive R objects
##
##inputs:                <NA>
##
##outputs:               <NA>
